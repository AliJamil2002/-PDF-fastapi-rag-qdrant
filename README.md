# -PDF-fastapi-rag-qdrant
A RAG chatbot API built with FastAPI and Qdrant that supports multiple document formats including PDF, DOCX, CSV, Markdown, and TXT.


Try AI directly in your favorite apps … Use Gemini to generate drafts and refine content, plus get Gemini Pro with access to Google's next-gen AI for PKR 5,600 PKR 1,400 for 3 months
1
100%
#
